    ...
    <>
      <li
        ...
        className={`flex justify-between items-center transition ${
          className
            ? className
            : 'text-sm md:text-15px  border-t border-skin-base first:border-t-0  py-3 xl:py-3.5 2xl:py-2.5 3xl:py-3'
        } ${isOpen ? 'text-skin-primary' : 'text-skin-base hover:text-skin-primary'}`}
      >
        <button
          className={cn(
