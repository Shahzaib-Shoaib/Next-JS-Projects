...
const BundleHeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <div
      className="flex justify-center xl:min-h-[350px] py-16 md:py-20 w-full bg-slate-100"

    >
      <div className="max-w-[540px] flex flex-col items-center justify-center relative mx-auto text-center xl:mb-8 px-5">
        <h2 className="text-2xl lg:text-3xl 2xl:text-[40px] 2xl:leading-[1.3em] font-bold text-skin-base  mb-2.5 lg:mb-3.5">
          {t(heroTitle)}
        </h2>
