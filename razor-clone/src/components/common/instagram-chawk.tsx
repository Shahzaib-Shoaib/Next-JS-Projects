...
const instagramFeed = [
  {
    ...
    title: 'text-man',
    slug: '/#',
    image: '/assets-chawk/images/instagram/1.jpg',
  },
  {
    id: 2,
    title: 'text-woman',
    slug: '/#',
    image: '/assets-chawk/images/instagram/2.jpg',
  },
  {
    id: 3,
    title: 'text-watch',
    slug: '/#',
    image: '/assets-chawk/images/instagram/3.jpg',
  },
  {
    id: 4,
    title: 'text-man',
    slug: '/#',
    image: '/assets-chawk/images/instagram/4.jpg',
  },
  {
    id: 5,
    title: 'text-sports',
    slug: '/#',
    image: '/assets-chawk/images/instagram/5.jpg',
  },
  {
    id: 6,
    title: 'text-fashion',
    slug: '/#',
    image: '/assets-chawk/images/instagram/6.jpg',
  },
]
  ...
  return (
    ...
    >
      {instagramFeed?.map((item) => (
        ...
        >
          <Image
            src={item.image ?? '/assets-chawk/placeholder/instagram.svg'}
