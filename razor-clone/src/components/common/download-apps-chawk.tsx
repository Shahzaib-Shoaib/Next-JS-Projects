...
const data = {
  ...
  appImage: '/assets-chawk/images/app.png',
  appImage2: '/assets-chawk/images/app2.png',
  appButtons: [
    {
      id: 1,
      slug: '/#',
      altText: 'button-app-store',
      appButton: '/assets-chawk/images/app-store.svg',
      buttonWidth: 209,
      buttonHeight: 60,
    },
    {
      ...
      appButton: '/assets-chawk/images/play-store.svg',
      buttonWidth: 209,
      buttonHeight: 60,
    },
  ],
  ...
  return (
    ...
    >
      ...
      <div className='hidden sm:flex items-end ps-4 -me-0.5 2xl:-me-1.5 w-60 md:w-72 lg:w-96 xl:w-auto'>
        <Image
          src={variant !== 'modern' ? appImage : appImage2}
