...
import HeaderMenu from '@components/layout/header/header-menu-chawk'
import Logo from '@components/ui/logo-chawk'
...
import LanguageSwitcher from '@components/ui/language-switcher-chawk'
const AuthMenu = dynamic(() => import('./auth-menu'), { ssr: false })
const CartButton = dynamic(() => import('@components/cart/cart-button-chawk'), {
  ssr: false,
})
