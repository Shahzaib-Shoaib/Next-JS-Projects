  ...
  return (
    ...
    >
      ...
      {variant === 'modern' && (
        <span
          className={cn(
            'absolute top-3.5 md:top-5 3xl:top-7 start-3.5 md:start-5 3xl:start-7 bg-[#B26788] text-white text-10px md:text-sm leading-5 rounded-md inline-block px-2 xl:px-3 pt-0.5 pb-1',
            {
