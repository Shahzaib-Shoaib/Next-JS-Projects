...
import ProductViewIcon from '@components/icons-chawk/product-view-icon'
import ProductWishIcon from '@components/icons-chawk/product-wish-icon'
import ProductCompareIcon from '@components/icons-chawk/product-compare-icon'
