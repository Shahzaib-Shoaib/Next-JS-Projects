// chawk
import SectionHeader from '@components/common/section-header-chawk'
import ProductCard from '@components/product/product-card-chawk'
import ProductCardGridLoader from '@components/ui/loaders/product-card-grid-loader-chawk'
import { useFlashSaleProductsQuery } from '@framework/product/get-all-flash-sale-products-chawk'
