...
type Action =
  ...
  | {
  type: 'OPEN_MOBILE_ALLCATEGORIES';
    }
  | {
  type: 'CLOSE_MOBILE_ALLCATEGORIES';
  }
  | {
      type: 'CLOSE_SHOP';
    }
...
function uiReducer(state: State, action: Action) {
  switch (action.type) {
    ...
    case 'OPEN_MOBILE_ALLCATEGORIES': {
        return {
            ...state,
          displayMobileAllCategories: true,
        };
    }
    case 'CLOSE_MOBILE_ALLCATEGORIES': {
      return {
        ...state,
        displayMobileAllCategories: false,
      };
...
export const UIProvider: React.FC = (props) => {
  ...
  const openMobileAllCategories = () => dispatch({ type: 'OPEN_MOBILE_ALLCATEGORIES' });
  const closeMobileAllCategories = () => dispatch({ type: 'CLOSE_MOBILE_ALLCATEGORIES' });
