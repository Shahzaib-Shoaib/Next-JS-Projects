...
import ListMenu from './mega-menu-razor';
        ...
        <div
            ...
            <Container className={"max-w-screen-2xl"}>
                <div className={`flex flex-row gap-5 pt-8 py-5`}>
                    <div className={`cateArea ${isBannerMode ? 'basis-3/4' : 'basis-full'} `}>
                        <ul className={`text-body text-sm grid grid-cols-${mega_categoryCol} gap-4 `}>
                    ...
                    {isBannerMode && (
                        <div className={`imageArea basis-1/4 ${mega_bannerMode == 'left' && 'order-first'}`}>
                            <Link
                                href={mega_bannerUrl}
            ...
            {mega_contentBottom.trim().length != 0 && (
                <div className="navPages-contentbottom bg-skin-carnation">
                    <Container>
                        <div className={`text-white text-sm text-center py-4`} dangerouslySetInnerHTML={{__html: mega_contentBottom}}/>
                    </Container>
                </div>
            )}
        </div>
