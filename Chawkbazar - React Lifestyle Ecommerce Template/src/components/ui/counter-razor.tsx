...
import MinusIcon from '@components/icons-razor/minus-icon';
import PlusIcon from '@components/icons-razor/plus-icon';
...
const Counter: React.FC<CounterProps> = ({
  ...
  return (
    <div
      className={cn(
        'button--mutiqty flex items-center justify-between rounded overflow-hidden flex-shrink-0 ',
        {
