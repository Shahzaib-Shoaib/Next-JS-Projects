...
import DeliveryIcon from "@components/icons-razor/featured/delivery-icon";
import ReferFriendsIcon from "@components/icons-razor/featured/refer-friends-icon";
import CardIcon from "@components/icons-razor/featured/card-icon";
import SupportIcon from "@components/icons-razor/featured/support-icon";
