...
import CategoryCard from '@components/cards/category-card-razor';
...
import CategoryListCardLoader from "@components/ui/loaders/category-list-card-loader-razor";

const Carousel = dynamic(() => import('@components/ui/carousel/carousel-razor'), {
    ssr: false,
});
