...
import SearchBox from '@components/common/search-box-razor';
import SearchProduct from '@components/common/search-product-razor';
import SearchResultLoader from '@components/ui/loaders/search-result-loader';
import useFreezeBodyScroll from '@utils/use-freeze-body-scroll-razor';
import Scrollbar from '@components/ui/scrollbar-razor';
