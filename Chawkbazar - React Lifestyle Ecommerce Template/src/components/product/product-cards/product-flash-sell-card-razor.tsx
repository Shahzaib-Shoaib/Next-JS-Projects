...
import ProgressCard from '@components/ui/progress-card-razor';
    ...
    if (completed) {
        ...
        return (
            <div
                ...
                <span
                    className="flex items-center justify-center min-w-[40px] md:min-w-[50px] min-h-[36px] md:min-h-[40px] bg-skin-four text-skin-base rounded p-1 mx-1 md:mx-1.5 lg:mx-2.5">
                  {zeroPad(days)}
                </span>
                :
                <span
