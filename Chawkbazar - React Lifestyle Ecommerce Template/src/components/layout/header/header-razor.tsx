...
// import {useModalAction} from '@components/common/modal/modal.context-razor';
...
import { Drawer } from "@components/common/drawer/drawer"; // similiar on both
...
const Header: React.FC = () => {
  ...
  return (
    <header
      ...
      ref={siteHeaderRef}
      className={cn(
        "header-five sticky-header sticky top-0 z-20 lg:relative w-full font-razor",
        displayMobileSearch && "active-mobile-search"
      )}
    >
      <div className="bg-skin-footer  innerSticky w-screen lg:w-full transition-all duration-200 ease-in-out body-font bg-skin-fill z-20">
        <Search
        ...
        <div className="top-bar  text-13px text-gray-300 border-b border-white/5">
          <Container className="h-12 flex justify-between items-center py-2 gap-5">
            <text className={`hidden md:block truncate text-sm`}>
        ...
        <div className="navbar hidden lg:block bg-skin-footer">
          <Container className="flex justify-between items-center">
            ...
            <div className="categories-header-button relative me-8 flex-shrink-0 w-72">
              ...
              {categoryMenu && <CategoryDropdownMenu className="" />}
            </div>
