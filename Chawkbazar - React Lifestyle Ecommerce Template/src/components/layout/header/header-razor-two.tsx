...
const Header: React.FC = () => {
  ...
  return (
      <header
          ...
          ref={siteHeaderRef}
          className={cn(
              ' header-five sticky-header sticky top-0 z-20 lg:relative w-full',
              displayMobileSearch && 'active-mobile-search'
          )}
      >
        <div
            className="innerSticky w-screen lg:w-full transition-all duration-200 ease-in-out body-font bg-skin-footer  z-20">
          <Search
          ...
          <div className="top-bar  bg-skin-footer text-13px text-gray-300 border-b border-white/10">
            <Container className="h-12 flex justify-between items-center py-2 gap-5">
          ...
          <div className="navbar hidden lg:block bg-skin-footer">
            <Container className="flex justify-between items-center">
              ...
              {/* End of logo */}
              <div className="categories-header-button relative me-8 flex-shrink-0 w-64">
                <button
