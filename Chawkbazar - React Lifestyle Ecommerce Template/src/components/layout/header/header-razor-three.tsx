...
const Header: React.FC = () => {
  ...
  return (
      <header
          ...
          ref={siteHeaderRef}
          className={cn(
              'header-three sticky-header sticky top-0 z-20 lg:relative w-full',
              displayMobileSearch && 'active-mobile-search'
          )}
      >
        <div
            className="innerSticky w-screen lg:w-full transition-all duration-200 ease-in-out body-font bg-skin-red z-20">
          <Search
          ...
          <div className="navbar hidden lg:block bg-skin-red">
