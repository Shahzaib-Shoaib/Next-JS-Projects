...
import HeaderMenu from '@components/layout/header/header-menu-razor';
import HeaderMenutop from '@components/layout/header/header-menutop-razor';
...
import UserIcon from '@components/icons-razor/user-icon';
import SearchIcon from '@components/icons-razor/search-icon';
// import {useModalAction} from '@components/common/modal/modal.context';
import useOnClickOutside from '@utils/use-click-outside';
import {FiMenu} from 'react-icons/fi';
import {AiOutlineUser} from 'react-icons/ai';
import Delivery from '@components/layout/header/delivery-razor';
import CategoryDropdownMenu from '@components/category/category-dropdown-menu-razor';
import {Drawer} from "@components/common/drawer/drawer";
import {getDirection} from '@utils/get-direction';
import {useRouter} from "next/router";
import {FiMapPin} from 'react-icons/fi';
import MobileAllCategories from "@components/layout/header/mobile-all-categories-razor";
...
const Header: React.FC = () => {
    ...
    return (
        <>
            ...
            >
                <div
                    className="innerSticky w-screen lg:w-full transition-all duration-200 ease-in-out body-font bg-skin-six z-20">
                    <Search
                    ...
                    <div className="navbar hidden lg:block bg-skin-six">
                        <Container className={"sm:max-w-[1730px]"}>
                            <div  className="flex justify-between items-center">
                                ...
                                <div className="categories-header-button relative me-8 flex-shrink-0 w-72">
                                    <button
                                        className={`border-white/10 min-h-[60px] focus:outline-none w-full font-medium text-white  uppercase py-4 flex items-center  ${dir == 'rtl' ? 'border-l' : 'border-r'}`}
            ...
            {categoryMenu && (
                <div className="shadow_bkg_show fixed w-full h-full inset-0 bg-black/70 z-40"
                     onClick={handleCategoryMenu}></div>
            )}
        </>
