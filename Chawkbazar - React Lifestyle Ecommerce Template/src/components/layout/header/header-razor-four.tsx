   ...
   // const {openModal} = useModalAction();
    ...
    return (
        <>
            ...
            >
                <div
                    className="innerSticky w-screen lg:w-full transition-all duration-200 ease-in-out body-font bg-skin-tints z-20">
                    <Search
                        ...
                        <Container className={"sm:max-w-[1730px]"}>
                            <div className="flex items-center justify-between  py-2 md:py-5">
                                ...
                                <SearchTop
                                    ...
                                    className="hidden lg:flex lg:max-w-[350px] xl:max-w-[500px] 2xl:max-w-[800px] lg:mx-10"
                                    variant="fill"
                                />
                                {/* End of search */}
                    ...
                    <div className="navbar hidden lg:block bg-skin-tints">
                        <Container className={"sm:max-w-[1730px]"}>
