...
import EmailIcon from '@components/icons-razor/email-icon';
import SendIcon from '@components/icons-razor/send-icon';
import Text from '@components/ui/text';
import Heading from '@components/ui/heading-razor';
...
const WidgetSubscription: React.FC<Props> = ({ className }) => {
  ...
  return (
    <div className={cn('flex flex-col', className)}>
      <Heading variant="mediumHeading" className="text-white mb-4 lg:mb-6 lg:pb-0.5">
        {t('footer:widget-title-subscribe')}
      </Heading>

      <Text className="text-gray-400 lg:-mt-1 max-w-[400px]">
      ...
      >
        ...
        <Input
          ...
          variant="solid"
          className="w-full"
          inputClassName="ps-10 md:ps-10 pe-10 md:pe-10 2xl:px-11 h-12 rounded-md bg-transparent border-white/20"
          {...register('email', {
