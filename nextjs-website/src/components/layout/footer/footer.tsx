const company = [
  ...
  export default function Footer() {
    return (
      <footer className='mx-auto container py-16 xl:px-20 lg:px-12 sm:px-6 px-4'>
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4'>
          <div className='flex flex-col flex-shrink-0'>
            <div>
              <p className='text-xl font-bold'>Fester</p>
            </div>
            <p className='text-sm leading-none text-gray-800 mt-4'>
              Copyright © 2022 Fester
            </p>
            <p className='text-sm leading-none text-gray-800 mt-4'>
              All rights reserved
            </p>
          ...
          <div className='sm:ml-0 ml-8'>
            <h2 className='text-base pb-3 font-semibold leading-4 text-gray-800'>
              Company
            </h2>
            {company.map((item, i) => (
          ...
          <div className='mt-10 lg:block hidden'>
            ...
            <div className='cursor-pointer flex items-center justify-between border border-gray-800 rounded-md mt-4'>
              <input
                type='text'
                className='text-base leading-4 p-4 w-full focus:outline-none rounded-md text-gray-800 placeholder-gray-800'
